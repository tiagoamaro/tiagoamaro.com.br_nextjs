...
export default function Quotes () {
  return (
    <Layout>
      ...
      <div className='quote'>
        <blockquote>
          The mark of a person who is in control of consciousness is the ability to focus attention at will,<br />
          to be oblivious to distractions, to concentrate for as long as it takes to achieve a goal, and not longer.<br />
          And the person who can do this usually enjoys the normal course of everyday life.<br />
          <small><cite>Mihaly Csikszentmihalyi, Flow</cite></small>
        </blockquote>
      </div>
      ...
      <div className='quote'>
        <blockquote>
          You can do a lot in a lifetime<br />
          If you don’t burn out too fast<br />
          You can make the most of the distance<br />
          First you need endurance —<br />
          First you’ve got to last…<br />
          <small><cite>Neil Peart (Marathon - Rush)</cite></small>
        </blockquote>
      </div>
      ...
      <div className='quote'>
        <blockquote>
          ...
          Nous voyons ainsi davantage et plus loin qu'eux, non parce que notre vue est plus aiguë ou notre taille plus haute, mais parce qu'ils nous portent en l'air et nous élèvent de toute leur hauteur gigantesque. <br />

          (We are dwarfs perched on the shoulders of giants, <br /> so we see more and more than they do, not because our sight is sharper or our height higher, but because they carry us up and we raise their gigantic height) <br />
          <small><cite>Bernard de Chartres</cite></small>
        </blockquote>
      </div>
      ...
      <div className='quote'>
        <blockquote>
          You can catch a monkey by burying a narrow-mouthed jar of nuts in the ground. <br />
          A monkey comes along, pits his paw into the jar and grabs a handful of nuts, but the mouth of the jar is too narrow to let him withdraw his clenched fist. <br />
          The monkey is unwilling to let go of the nuts and so is trapped. <br />
          You too can be trapped by not letting go of your beliefs, opinions, worries and anxieties. <br />
          <small><cite>Michael Michalko - Thinkertoys</cite></small>
        </blockquote>
      </div>
      ...
      <div className='quote'>
        <blockquote>
          The quality of our mental models determines whether the code we write does what we expect it to do. <br />
          And that translates directly into avoiding bugs and meeting deadlines. <br />
          The more effective our models, the more work we're able to get done. <br />
          <small><cite>Avdi Grimm</cite></small>
        </blockquote>
      </div>
      ...
      <div className='quote'>
        <blockquote>
          ...
          And write them knowing that, you're not to write them unless you're willing to stand behind them. <br />
          Then understand that if you're called to stand behind them, <br />
          That is in fact how you will become educated. <br />
          <small><cite>Jordan Peterson</cite></small>
        </blockquote>
      </div>
      ...
      <div className='quote'>
        <blockquote>
          ...
          <br />
          <small><cite>Sam Hatoum</cite></small>
        </blockquote>
      </div>
      ...
      <div className='quote'>
        <blockquote>
          ...
          <small><cite>Master Yoda - Star Wars Universe</cite></small>
        </blockquote>
      </div>
      ...
      <div className='quote'>
        <blockquote>
          ...
          <small><cite>Mike Perham</cite></small>
        </blockquote>
      </div>
      ...
      <div className='quote'>
        <blockquote>
          ...
          <small><cite>The Zen of Python, by Tim Peters</cite></small>
        </blockquote>
      </div>
      ...
      <div className='quote'>
        <blockquote>
          ...
          <br />
          <small><cite>David Heinemeier Hansson</cite></small>
        </blockquote>
      </div>
      ...
      <div className='quote'>
        <blockquote>
          ...
          <br />
          <small><cite>Julia Gostkorzewicz</cite></small>
        </blockquote>
      </div>
      ...
      <div className='quote'>
        <blockquote>
          ...
          <br />
          <small><cite>Martin Fowler</cite></small>
        </blockquote>
      </div>
      ...
      <div className='quote'>
        <blockquote>
          ...
          <br />
          <small><cite>Rebecca Wirfs-Brock, Object Design</cite></small>
        </blockquote>
      </div>
      ...
      <div className='quote'>
        <blockquote>
          ...
          <br />
          <small><cite>Avdi Grimm, The Soul of Software</cite></small>
        </blockquote>
      </div>
    </Layout>
  )
